 ...
 */
public class BannerCarousel extends MotionHelper {
    ...
    private boolean mAutoBanner = false;
    ...
    public BannerCarousel(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
        if (null != attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, com.pp.ui.R.styleable.BannerCarousel);
            mAutoBanner = a.getBoolean(com.pp.ui.R.styleable.BannerCarousel_autoBanner, mAutoBanner);
            a.recycle();
        }
    }
   ...
   /* public void transitionToIndex(int index, int delay) {
    ...
    private final long bannerDuration = 2000L;
    ...
    private final Runnable bannerRunnable = new Runnable() {
        ...
        public void run() {
            int delay = 1000;
            transitionToIndex(mIndex + 1, delay);
    ...
    private final OnTouchListener motionLayoutOnTouchListener = new OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent motionEvent) {
            ...
            switch (motionEvent.getAction()) {
                ...
                case MotionEvent.ACTION_CANCEL:
                    if (mMotionLayout.getProgress() == 0) {
                        startBanner();
                    } else {
                        mMotionLayout.addTransitionListener(new TransitionAdapter() {
                            @Override
    ...
    private void setupBanner() {
        ...
        mMotionLayout.setOnTouchListener(motionLayoutOnTouchListener);
